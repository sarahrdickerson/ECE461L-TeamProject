...
from flask import Flask, jsonify, render_template_string, url_for, redirect
...
@app.route('/')
def home():
    return render_template_string('../frontend/public/index.html')
...
def login():
    ...
    return render_template_string('../frontend/templates/login.html', form=form)

@app.route('/dashboard', methods=['GET', 'POST'])
@login_required
def dashboard():
    return render_template_string('../frontend/templates/dashboard.html', name=current_user.username)
...
def register():
    ...
    return render_template_string('../frontend/templates/register.html', form=form)
